...
options = ([
    ...
    [_("Time zone"),"int","tz", _("Example: GMT-4:00, GMT+5:30 (effective after reboot.)"),"System"],
    [_("24-hour clock"),"boolean","tf", _("Display times in 24 hour format (as opposed to AM/PM style.)"),_("System")],
    [_("HTTP port"),"int","htp", _("HTTP port (effective after reboot.)"),"System"],
    ...
    [_("New password"),"password","npw", _("Enter a new password."),"Change Password"],
    ...
    [_("Master station"),"int","mas", _("Select master station."),"Configure Master"],
